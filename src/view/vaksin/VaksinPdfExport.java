...
public class VaksinPdfExport {
    public void export(List<Vaksin> vaksinList) throws IOException {
        String outputFileName = System.getProperty("user.dir") + File.separator +"pdf" + File.separator + "Daftar_Data_Vaksinasi_" + UUID.randomUUID() + ".pdf";
        ...
        Cell<PDPage> cell = headerRow.createCell(100, "Daftar Data Vaksinasi");
        ...
        cell = row.createCell(27, "Nama");
        cell.setAlign(HorizontalAlignment.CENTER);
        cell.setFontSize(15);
        
        cell = row.createCell(20, "Jenis Vaksin");
        cell.setAlign(HorizontalAlignment.CENTER);
        cell.setFontSize(15);
        
        cell = row.createCell(25, "No Telepon");
        cell.setAlign(HorizontalAlignment.CENTER);
        cell.setFontSize(15);
        
        cell = row.createCell(20, "Vaksin Ke-");
        cell.setAlign(HorizontalAlignment.CENTER);
        cell.setFontSize(15);
        ...
        for (Vaksin vaksin : vaksinList) {
            ...
            cell = row.createCell(27, vaksin.getNama());
            cell.setFontSize(15);
            cell = row.createCell(20, vaksin.getJenisVaksin().getNama());
            cell.setFontSize(15);
            cell = row.createCell(25, vaksin.getNoTelp());
            cell.setFontSize(15);
            cell = row.createCell(20, vaksin.getVaksinKe());
            cell.setFontSize(15);
            no++;
        }
